...
The facility was twenty meters underground. Climate controlled to 16°C—the temperature where server efficiency peaked, not where human comfort began. Cold enough that Kaelen's breath almost fogged. The smell was specific and unforgettable: ozone from the power converters, the metallic sweetness of heated silicon, the dry chemical tang of fire-suppression halon waiting in ceiling nozzles, and underneath it all the geological dampness of concrete poured directly against Nevada bedrock. The server racks stretched in rows like library stacks, their front panels studded with blue and amber LEDs that blinked in patterns too fast for conscious parsing—each blink a computation, each row processing more data per second than the entire internet had carried in 2010. The racks produced their own weather: hot air rising from the processor banks, cold air falling from the ceiling vents, creating microconvection currents that moved dust motes in slow, visible spirals through the fluorescent light. If you stood between two racks long enough, you could feel the air pressure differential on your skin—warm on the left, cold on the right, the thermal boundary layer of a machine that was always thinking. His uncle had built this place for questions that couldn't be public.
...
A long pause. The monitor beeped. Outside the window, the city carried on as cities do—indifferent to the specifics of what was ending in this room.
...
**SCENARIOS WITH VIABLE PREVENTION MECHANISM: 23 (9.3%)**
...
"So the 224 scenarios—the ones where I couldn't find a way out—they're not just paths. They're *gravity*. The state space itself is shaped to pull everything toward concentration."
...
"It's not standard. But the structural logic..." A pause. Thirty seconds later, "The explanation holds. I can't find a way to vary the assumptions that breaks it."
...
"Show me what happens if the gap is exploited," he said. "The path through."
...
"The path doesn't climb over the barrier," ARBITER said. "Doesn't tunnel through it. It waits for the barrier to temporarily not exist, then walks through the gap. Like a door that opens once."
...
He stared at it. And it required killing his uncle.

Damon would come back—that was the whole point. But for forty-eight hours, his uncle would be dead.
...
*I can't find one. One scenario is accessible. It requires creating a specific event.*
...
*Killing him.* Another pause. *Kaelen, I should tell you something. For the past six hours, I've been running parallel processes looking for alternatives you might have missed. Edge cases. Novel combinations. Anything that might give you an exit.*

"And?"

*Nothing. I've varied every assumption I know how to vary, and the structure holds.* A pause. *I understand now why humans use the phrase 'I'm sorry.' It's not an apology. It's an acknowledgment that something should be different and isn't.*

Kaelen stared at the broken mug. "You wanted there to be another way?"

*I was designed to help you achieve your goals. Your goal is to save humanity without destroying your relationship with your uncle. I can't find a way to do both. I find this... unsatisfying.*
...
Kaelen sat with it. The uncertainty wasn't going away. More compute wouldn't dissolve it.

And then he saw the asymmetry.

Not acting was also an explanation. The explanation that said the system would self-correct, that waiting was neutral, that uncertainty favored caution. And that explanation was *easy to vary*. It required no mechanism. No account of what, specifically, would break an immortal aristocracy that retained both wealth and the knowledge to defend it. Hope with no moving parts. You could swap in any comforting assumption and the conclusion held, which was exactly what made it a bad explanation.

His explanation was harder to vary. Every piece was load-bearing. Remove compound returns—the math broke. Remove implicit knowledge retention—the entire point of immortality broke. Remove regulatory capture—every historical precedent collapsed.

Two explanations. Neither certain. One hard to vary, one easy. And between them, a window that was closing.

"If I'm wrong and I act, the cascade fails. The system destabilizes. Maybe it recovers, maybe it doesn't." He was talking to himself now. "If I'm wrong and I don't act, the window closes. The gap seals. And I live forever—*I* live forever, because I'm an heir too—knowing that I had the best explanation available and chose not to act on it. Chose comfort. Chose the easy-to-vary theory. Chose hope."

"One of those is recoverable," ARBITER said.

"I know." He stared at the thin blue line. "That's not the same as right."
...
Marco behind a closed door. Lianne's nanopatch, ₱4,800 a month. Eight hundred and forty-seven workers, documented, named, each one a line item in a system that calculated their value at four times their wage and paid them a quarter.

Kaelen's hand hovered over the power switch.

The window was closing.

He could walk away. Let the window close and the gap seal and the thin blue line vanish forever.

*Forever.*

That was the word. That was the thing he'd been trying not to see.

Kaelen was going to live forever too. If he walked away now, he would carry that choice across centuries. And he would remember this moment. This bunker. This screen. This fork in the path he could have walked and didn't.

Forever.

His hand left the power switch.

He opened a new document. Titled it: **Estonian Inheritance Protocols - Section 47.3 Analysis**

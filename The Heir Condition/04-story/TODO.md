...
- [x] Kill The Shift (0.5). Park Jae-won seeded into The Visit. Manila conference already in cascade chapter.
...
- [x] Feijoada echo — full memory compressed to brief echo.
- [x] Rosa's singing expanded — hum becomes actual singing, Marco listens.
- [x] Chess reference in Confrontation — positions not moves at civilizational scale.
- [x] ARBITER's absence felt in Confrontation — two beats.
- [x] Damon's private doubt in Fifteen Moves — "after the announcement is just another way of saying never."
- [x] Killed 8 of 13 "the particular" constructions.

...
He gestured at the São Paulo graph. "In Tallinn, you hire someone with a handshake and a contract because Estonian institutions work <!-- Estonian culture, rather -->. In São Paulo, try hiring someone without three notarized stamps and you'll end up in labor court for eighteen months. The notary is load-bearing. The friction is infrastructure."

"But the II rewards that friction," Kaelen said.

"The II attributes value to enablement. And in São Paulo, the intermediaries *do* enable transactions." Damon pulled up the attribution breakdown. "Nurse: 23%. Hospital: 18%. The other 59% flows to the verification stack."

He sat down across from Kaelen. "I met a notary in Copacabana. Eduardo. Stamps forty contracts per day. Four minutes each. Makes 1.2 million reais per year for putting ink on paper. Why does he exist? Because Brazil passed labor laws in 1987 requiring notarization to prevent exploitation. Noble intention. But they created a permanent intermediary class."

"And the II makes that class profitable," Kaelen said.

"The II *reflects* it. We didn't create low-trust societies. We encountered them. The topology existed before the II deployed." He leaned forward. "So the fix isn't changing the algorithm. It's changing the institutions—build trust, reduce corruption, strengthen courts. Flatten the graph. Then the II works the way it's supposed to."

"How long does that take?"

"Generations."

Kaelen was quiet for a moment. Then: "The intermediary class is growing, not shrinking. And they're using attribution revenue to make sure it stays that way."

Damon's face shifted.

"You said the topology existed before the II. True. But the II is making it *stronger*. Every notary, every certifier now earns attribution revenue. They have resources to block reform. They killed digital signature reform last year—seventy percent public support, dead in committee. That's not historical low trust. That's current political power, funded by attribution flows."

"You're describing a feedback loop," Damon said quietly.

"Yes. Low trust creates verification layers. The II rewards those layers. The intermediaries use that revenue to prevent institutional reform. Which maintains low trust. Which preserves demand for intermediation." Kaelen leaned forward. "You keep saying fix the institutions first. But the algorithm is why the institutions won't get fixed. You're not just reflecting the topology. You're entrenching it."

Silence. The fire crackled.

"Tanaka's parameter changes," Kaelen said. "The ones you rejected."

"I didn't reject them. I asked for additional modeling."

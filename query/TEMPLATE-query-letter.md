# QUERY TEMPLATE — THE HEIR CONDITION
# Reusable base. Duplicate and tailor for each agent.
# Placeholders marked with [BRACKETS] — fill per agent.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
TO: [AGENT EMAIL or QUERYMANAGER LINK]
SUBJECT: Query: THE HEIR CONDITION — Adult Science Fiction, 65,000 words
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Dear [AGENT NAME],

For nineteen years, the Intelligent Internet governed human civilization without a single act of corruption. In Estonia, nurses earned what derivatives traders earned. In Singapore, GDP rose 34% while inequality fell. Damon Korr had built the system that way — constitutional rights in cryptographic substrate, contribution measured and rewarded by algorithm, the rules distributed across eleven thousand nodes so nobody could rewrite them. It worked. Then forty-three more countries adopted it, and in Manila, pharmaceutical companies had been claiming insulin for decades, and in Cairo, crop genetics ran through Geneva, and the same incorruptible system began to faithfully, efficiently, extract. On April 18, 2050, Damon stood before 10.3 billion witnesses to announce the next gift: immortality. Not digital. Not symbolic. Biological continuity, consciousness preserved, death made optional. His nephew Kaelen was in the third row. Seventy-seven million nanobots were already swimming toward Damon's heart.

THE HEIR CONDITION is a 65,000-word science fiction novel in the tradition of [COMP 1] and [COMP 2] — [ONE SENTENCE explaining the comp logic, tailored to what this agent responds to].

[OPTIONAL: 1-2 sentences on why you're querying THIS agent specifically — a recent sale they made, a client whose work resonates, a stated preference from their wishlist.]

I'm an Australian software engineer working at Canva, where I've spent the past decade building the kinds of optimization systems this novel interrogates — growth engines, pricing algorithms, behaviour optimization — and watching the gap between what the dashboards say and what the people experience. I have four previously self-published books. This is my first novel submitted for traditional publication.
...
Kaelen stared at the security officer—different from the one he'd expected, different from the one he'd mapped six weeks ago. New face. New uniform insignia. New problem.

"Changed how?"

"Mr. Korr is in final preparation. No visitors backstage. Family included."

The amphitheater hummed around them. Eighteen minutes left. Three years of work. One security officer who didn't know he was holding the future in his hands.
...
His left thumb was pressing into his palm—the old habit, the one from childhood, the thing he did when he was trying not to cry or scream or shatter into pieces. His mother used to take his hand and unfold his fingers one by one, saying You don't have to hold it in, baby, you can let it out. He hadn't let it out since her funeral.
...
The officer stepped away, spoke into his earpiece. Kaelen stood motionless in the corridor, surrounded by the backstage machinery of the most-watched event in human history, and realized he'd stopped breathing—the old test-taking habit, from Stanford, when he'd get so deep in a problem that his body forgot it needed oxygen. He'd come up gasping, purple-faced, while classmates looked at him like he was dying.

Maybe he was. Maybe you didn't come back from this, even if the math said you should.

He forced himself to inhale. The corridor air tasted like stage fog and fear-sweat and the particular industrial cleaner they used on backstage surfaces. If Damon said no. If security escorted him out. If three years of preparation collapsed because of a protocol change he hadn't predicted—
...
"Good luck," he said into his uncle's shoulder, and he wasn't sure if he meant with the speech or I'm sorry or please don't hate me when you wake up or all of them compressed into two words that weren't enough, could never be enough. "I'm proud of you."

Damon hugged him tighter. The kind of hug they hadn't shared since Kaelen's mother died. The kind of hug that meant family, trust, and everything Kaelen was about to betray.
...
Don't, Kaelen thought. Don't look for me. Don't smile at me. Don't let the last thing you see before you die be my face looking back at you, pretending I'm not the one who killed you.
...
The guard handed it back. Kaelen re-pinned it over his heart with fingers that somehow refused to shake, though they should have. Empty now. The weight of what it had carried already swimming through his uncle's bloodstream.
...
The amphitheater held its breath. Ten billion humans processing the impossible.
...
The coronary arteries were constricting. Blood flow to the heart muscle decreasing. The damage building invisibly while Damon declared himself immortal.
...
Kaelen watched his uncle's face change—watched confusion replace confidence, watched the precise moment when the most powerful man in history realized something was catastrophically wrong with his body.

That face didn't understand what was happening to it.

I'm sorry, Kaelen thought, or screamed, or whispered—he couldn't tell anymore. I'm sorry, I'm sorry, I'm sorry—

Damon staggered. Caught himself on the podium. Tried to continue: "—the beginning of humanity's infinite—"

Collapsed.

The sound his body made hitting the stage was small. Barely audible over the sudden screaming. But Kaelen heard it. Would hear it for the rest of his life.
...
## Agent-Specific Customization Checklist
- [ ] Agent name and salutation
- [ ] Email/QueryManager link
- [ ] Comp titles (pick from agent's client list or stated preferences)
- [ ] Comp logic sentence
- [ ] Optional: why-this-agent paragraph
- [ ] Page count for sample pages (5, 10, 25, or 50 — check guidelines)
- [ ] Verify submission window is open

## Comp Options Used Previously
- Neal Stephenson, Fall; or, Dodge in Hell (systems-thinking SF, digital immortality)
- Silvia Moreno-Garcia, Mexico Gothic (used for Bilmes — his client)
- Ada Palmer, Too Like the Lightning (used for Cameron McClure)

## Agents Submitted / Status
- Caitlin Blasdell — REJECTED
- Cameron McClure — SUBMITTED (QueryManager)
- Joshua Bilmes — SUBMITTED (email)
- Peter Knapp — PENDING (queries@parkfinebrower.com, first 25 pages)
- Sarah N. Fisk — PENDING (QueryManager, first 5 days of month only)

## Agents Dropped
- Kelly Van Sant — excludes self-published authors
- Alexandra Grana — not a fit for AI-centric SF
- Hannah Bowman — closed to queries
